...
export default function Footer() {
  return (
    <>
      <div className="h-[490px] bg-footerImg flex justify-center z-[.9] items-center bg-center bg-cover">
        <div className="bg-opacity-40 w-full h-full  flex flex-col justify-around items-center px-24 text-white">
